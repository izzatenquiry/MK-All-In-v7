    ...
    const renderGridItem = (item: HistoryItem, index: number) => {
        ...
        return (
            ...
            >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/20 opacity-90 group-hover:opacity-100 transition-opacity flex flex-col justify-between p-3">
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button
                            ...
                            className="p-2 bg-amber-500/90 text-white rounded-full hover:bg-amber-600 transition-colors transform hover:scale-110"
                            title={T.download}
                        >
