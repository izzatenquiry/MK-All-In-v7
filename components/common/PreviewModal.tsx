  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-h-0 min-w-0 flex items-center justify-center w-full overflow-hidden">
          <div className="w-full h-full min-h-0 min-w-0 flex items-center justify-center">
            {isImage && (
              <img src={displayUrl} alt={item.prompt} className="max-w-full max-h-full min-w-0 min-h-0 w-auto h-auto object-contain object-center rounded-md" />
            )}
            {isVideo && displayUrl && (
              <video src={displayUrl} controls autoPlay className="max-w-full max-h-full min-w-0 min-h-0 w-auto h-auto object-contain object-center rounded-md" />
            )}
          </div>
        </div>
