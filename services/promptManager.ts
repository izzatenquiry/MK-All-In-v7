...
**Image Reference Mapping:** Reference images are provided in upload order. Image 1 = first image, Image 2 = second image, Image 3 = third image, Image 4 = fourth image. When the user references "Image 1", "Image 2", etc., use the corresponding image in that exact order.
